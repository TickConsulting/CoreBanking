...
class Group extends Group_Controller{
    ...
    public function group_setup(){
        ...
        $this->template->set_layout('setup_tasks.html')->title('Group Setup Tasks')->build('group/group_setup',$this->data);
    }
    ...
    public function accounts(){
        ...
        $this->template->set_layout('setup_tasks.html')->title('Group Accounts')->build('group/accounts',$this->data);
    }
    ...
    public function members(){
        ...
        $this->template->set_layout('setup_tasks.html')->title('Group Members')->build('group/members',$this->data);
    }
    ...
    public function contributions(){
        ...
        $this->data['fine_limit_options'] = $this->contribution_invoices->fine_limit_options;
        $this->data['percentage_fine_on_options'] = $this->contribution_invoices->percentage_fine_on_options;
        $this->template->set_layout('setup_tasks.html')->title('Group Contributions')->build('group/contributions',$this->data);
    }
    ...
    public function date(){
        ...
        $this->template->set_layout('back_date.html')->title('Set Date')->build('group/date',$this->data);
    }
    ...
    public function contribution_targets(){
        ...
        $this->template->set_layout('back_date.html')->title('Back Date Contributions')->build('group/contribution_targets',$this->data);
    }
    ...
    public function contribution_refunds(){
        ...
        $this->data['group_member_total_contribution_back_dated_arrears_per_contribution_array'] = $this->invoices_m->get_group_member_total_contribution_back_dated_arrears_per_contribution_array();
        $this->data['group_cut_off_date'] = $group_cut_off_date;
        $this->template->set_layout('back_date.html')->title('Back Date Contributions Refunds')->build('group/contribution_refunds',$this->data);
    }
    ...
    public function fines_issued(){
        ...
        $this->template->set_layout('back_date.html')->title('Back Date Fines Issued')->build('group/fines_issued',$this->data);
    }
    ...
    public function expenses(){
        ...
        $this->template->set_layout('back_date.html')->title('Back Date Expenses')->build('group/expenses',$this->data);
    }
