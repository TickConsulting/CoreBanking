			...
			<div class="m-form__heading pb-3">
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<h3 class="m-form__heading-title"><?php echo translate('Group Applicant Details
');?></h3>
					</div>
					<div class="col-lg-6 col-sm-12">
						<a href="#" class="btn btn-primary float-right btn-sm" id="add_member_form">
							<span>
								...
								<span><?php echo translate('Add Member(s)');?></span>
							</span>
						</a>
					</div>
				</div>
				...
				<table class="table table-striped- table-bordered table-hover table-checkable members setup_table" id="members_listing">
				   	<thead>
				      	<tr>
					        ...
					        <th><?php echo translate('Group Role');?></th>
					...
					<table class="table" id="multiple-entries">
						<thead>
							<tr>
								...
								<th width="24%"><?php echo translate('Group Role');?> <span class="required">*</span></th>
								<th width="5%"></th>
							</tr>
						</thead>
			  	...
			  	<div class="modal-dialog modal-dialog-centered" role="document">
			    	<div class="modal-content">
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn btn-secondary cancel_form" id="close_add_role" data-dismiss="modal"><?php echo translate('Close')?></button>
			        		<button type="button" class="btn btn-primary" id="add_new_role_btn"><?php echo translate('Save Changes');?></button>
			      		</div>
		      			<?php echo form_close();?>
			    	</div>
			  	</div>
	...
	<div  id="create_group_contribution_panel">
		<div class="m-form__section m-form__section--first">
			<div class="m-form__heading pb-3">
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<h3 class="m-form__heading-title"><?php echo translate('Group Contribution Setup');?></h3>
					</div>
					<div class="col-lg-6 col-sm-12">
						<a href="#" class="btn btn-primary m-btn--icon float-right btn-sm" id="create_contribution_form">
							<span>
								<i class="la la-plus"></i>
								<span><?php echo translate('Create Contribution')?></span>
							</span>
						</a>
					</div>
				</div>
			...
			<div class="create_contribution_settings">
				<?php echo form_open_multipart($this->uri->uri_string(), ' class="form_submit m-form m-form--state" role="form" id="create_contribution"'); ?>
					<div id="contribution_settings">
			            ...
			            <div id="enable_checkoff" class="form-group m-form__group pt-0 m--padding-10 d-none row">
	                        <div class="col-lg-12 m-form__group-sub m-input--air">
	                    ...
	                    <?php echo form_hidden('enable_deposit_statement_display',1,1,''); ?>

	                    <!-- <div id="enable_deposit_statement_display" class="form-group m-form__group d-none pt-0 m--padding-10 row">
	                        <div class="col-lg-12 m-form__group-sub m-input--air">
					...
					<div id ="contribution_fines">
						<fieldset class="m--margin-top-20">
							<legend><?php echo translate('Contribution Fines')?></legend>
							<div class="form-group m-form__group row pt-0 m--padding-10">
								<div class="col-lg-12 m-form__group-sub">
				...
				<div class="m-portlet m-portlet--creative m-portlet--bordered-semi pt-0 mt-0 pb-0 mb-5">
					<div class="m-portlet__body m-demo__preview add_setting_fine">
						<div class="form-group m-form__group row">
							<div class="col-lg-12 m-form__group-sub">
								<label><?php echo translate('We charge a');?></label>
								<a href="javascript:;" class="m-badge m-badge--danger m-badge--wide bage-link float-right remove-fine-setting"><?php echo translate('Remove')?></a>
			                    <div class="row">
			                        <div class="col-md-4 col-sm-12 m-form__group-sub m-input--air">
	...
	<div id="create_group_loan_types_panel">
		<div class="m-form__section m-form__section--first">
			<div class="m-form__heading pb-3">
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<h3 class="m-form__heading-title"><?php echo translate('Group Loan Types');?></h3>
					</div>
					<div class="col-lg-6 col-sm-12">
						...
						<div class="form-group m-form__group interest_type_input_group pt-0 m--padding-10">
							<div class="row">
								<div class="col-sm-4 m-form__group-sub">
									<label><?php echo translate('Interest Type')?><span class="required">*</span></label>
	...
	<div id="create_group_bank_account_panel">
		<div class="m-form__section m-form__section--first">
			<div class="m-form__heading pb-3">
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<h3 class="m-form__heading-title"><?php echo translate('Group Accounts');?></h3>
					</div>
					<div class="col-lg-6 col-sm-12">
						<a href="#" class="btn btn-primary m-btn m-btn--custom m-btn--icon float-right btn-sm" id="add_bank_account_header">
							<span>
								<i class="la la-plus"></i>
								<span><?php echo translate('Add Group Account');?></span>
							</span>
						</a>
					</div>
				</div>
				...
				<ul class="nav nav-tabs" role="tablist">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#sacco_account_tab" onClick="handle_tab_switch('sacco_account')">
                            <?php echo translate('Group Account');?>
                        </a>
                    </li> -->
                    <!-- <li class="nav-item">
							...
							<div class="bank_change_options">
								<div class="form-group m-form__group row pt-0 m--padding-10 ">
									<div class="col-sm-6 m-form__group-sub m-input--air">
										...
										<?php echo form_dropdown('bank_id',array(''=>'--Select Bank--')+$banks,$default_bank->id,'class="form-control bank_id m-select2" id="bank_id" placeholder="Bank Name"'); ?>
									...
									<div class="col-sm-6 m-form__group-sub m-input--air">
										...
										<?php echo form_dropdown('bank_branch_id',$bank_branches?(array(''=>'--Select bank branches--')):(array(''=>'--Select bank first--'))+$bank_branches,'','class="form-control bank_branch_id m-select2 bank_branches_space" placeholder="Bank Branch Name"'); ?>
										<span class="m-form__help"><?php echo translate('Select option');?></span>
									</div>
								</div>
								<?php echo form_hidden('id','');?>
								<div class="form-group m-form__group row pt-0 m--padding-10 ">
									<div class="col-sm-6">
										...
										<?php echo form_input('account_number','','class="form-control account_number bank_account_number m-input--air" placeholder="Bank Account Number" id="bank_account_number"'); ?>
									</div>
									<div class="col-sm-6 m-form__group-sub m-input--air">
										<label><?php echo translate('Account Currency');?><span class="required">*</span></label>
										<?php echo form_dropdown('account_currency_id',array(''=>'--Select account currency--')+$currencies,'','class="form-control account_currency m-select2" id="account_currency" placeholder="Bank Branch Name"'); ?>
										<span class="m-form__help"><?php echo translate('Select option');?></span>
									</div>
									
								</div>
								<div class="form-group m-form__group row pt-0 m--padding-10 bank_account_hidden_fields" style="display: none">
									<div class="col-sm-12">
										<label><?php echo translate('Bank Account Name');?><span class="required">*</span></label>
										<?php echo form_input('account_name','','class="form-control account_name m-input--air" placeholder="Bank Account Name" id="account_name" readonly="readonly"'); ?>
									</div>
									<!-- <div class="col-sm-6">
								...
								<div  class="form-group m-form__group pt-0 m--padding-10 row bank_account_hidden_fields" style="display: none">
				                   	<div class="col-lg-12 m-form__group-sub m-input--air">
				                   		<label><?php echo translate('Select Bank Account Signatories');?></label>
				                   		<div class="signatories_tab">
				                        	<?php echo form_dropdown('account_signatories[]',$this->active_group_member_options,$this->input->post('contribution_member_list'),' id="" class=" form-control m-select2 account_signatories" multiple="multiple" id="account_signatories" data-placeholder="Select..." readonly="readonly"'); ?>
				                        </div>
				                    </div>
				                </div>
								...
								<div class="m--margin-top-50">
									<div class="col-lg-12 col-md-12">
										<span class="float-lg-right float-md-left float-sm-left float-xl-right">
											<button class="btn btn-primary m-btn m-btn--custom m-btn--icon btn-sm" id="add_bank_account_button" type="button" disabled="disabled">
												<?php echo translate('Save Changes');?>
											</button>
											&nbsp;&nbsp;
							...
							<div class="sacco_change_options">
								<div class="form-group m-form__group row pt-0 m--padding-10 ">
									<div class="col-sm-12 m-form__group-sub m-input--air">
										...
										<?php echo form_dropdown('sacco_id',array(''=>'--Select Group--')+$saccos,'','class="form-control bank_id m-select2" placeholder="Sacco Name"'); ?>
										<span class="m-form__help"><?php echo translate('Select option');?></span>
									</div>
								</div>
								<div class="form-group m-form__group row pt-0 m--padding-10 ">
									<div class="col-sm-6 m-form__group-sub m-input--air">
										<label><?php echo translate('Group Branch');?><span class="required">*</span></label>
										<?php echo form_dropdown('sacco_branch_id',array(''=>'--Select Group first--'),'','class="form-control sacco_branch_id m-select2 sacco_branches_space" placeholder="Group Branch Name"'); ?>
										<span class="m-form__help"><?php echo translate('Select option');?></span>
									</div>
									<div class="col-sm-6">
										<label><?php echo translate('Group Account Name');?><span class="required">*</span></label>
										<?php echo form_input('account_name','','class="form-control account_name m-input--air" placeholder="Group Account Name"'); ?>
									</div>
								</div>
								<?php echo form_hidden('id','');?>
								<div class="form-group m-form__group row pt-0 m--padding-10">
									<div class="col-sm-6">
										<label><?php echo translate('Group Account Number');?><span class="required">*</span></label>
										<?php echo form_input('account_number','','class="form-control account_name m-input--air" placeholder="Group Account Number"'); ?>
									</div>

									<div class="col-sm-6">
										<label><?php echo translate('Initial/Current Account Balances');?><span class="required">*</span></label>
										<?php echo form_input('initial_balance','','class="form-control initial_balance currency m-input--air" placeholder="Group Account Balance"'); ?>
									</div>
								</div>
								<div class="m--margin-top-50">
									<div class="col-lg-12 col-md-12">
			...
			<div class="m-form__heading pb-0 mb-0">
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						...
						<p><?php echo translate("That's all we need for now. Kindly review your data below before you submit")?>.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="m-accordion m-accordion--bordered" id="m_accordion_1" role="tablist">
				...
				<div class="m-accordion__item active">
					<div class="m-accordion__item-head"  role="tab" id="m_accordion_1_item_1_head" data-toggle="collapse" href="#m_accordion_1_item_1_body" aria-expanded="  false">
						...
						<span class="m-accordion__item-title">1. <?php echo translate('Group Information');?></span>
						...
						<div class="tab-content active  m--padding-30">
							<div class="m-form__section m-form__section--first">
								<div class="form-group m-form__group m-form__group--sm row">
									<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Group Name');?>:</label>
								...
								<div class="form-group m-form__group m-form__group--sm row">
									<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Group Size');?>:</label>
									<div class="col-xl-8 col-lg-8">
										<span class="m-form__control-static"><?php echo $this->group->size;?> <?php echo translate('Members');?> </span>
									</div>
								</div>
								<div class="form-group m-form__group m-form__group--sm row">
									<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Group Type');?>:</label>
									<div class="col-xl-8 col-lg-8">
								...
								<?php if($this->group->group_offer_loans){?>
									<div class="form-group m-form__group m-form__group--sm row">
										<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Allow Group members to apply for loans')?></label>
										<div class="col-xl-8 col-lg-8">
								...
								<div class="form-group m-form__group m-form__group--sm row d-none">
									<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Enable Member Information Privacy')?></label>
									<div class="col-xl-8 col-lg-8">
										<span class="m-switch m-switch--sm m-switch--icon">
											<label>
								...
								<div class="form-group m-form__group m-form__group--sm row d-none">
									<label class="col-xl-4 col-lg-4 col-form-label"><?php echo translate('Disable "Member Directory" from members')?></label>
									<div class="col-xl-8 col-lg-8">
										<span class="m-switch m-switch--sm m-switch--icon">
											<label>
				...
				<div class="m-accordion__item">
					<div class="m-accordion__item-head collapsed" role="tab" id="m_accordion_1_item_2_head" data-toggle="collapse" href="#m_accordion_1_item_2_body" aria-expanded="    false">
						...
						<span class="m-accordion__item-title">2. <?php echo translate('Group Members');?></span>
			...
			<div class="set_admin_member_holder">
				<div class="form-group m-form__group m-form__group--sm mt-5 row admin_member_id">
					<div class="col-lg-12 m-form__group-sub m-input--air col-sm-12 m-input--air admin_member_id">
						<label><?php echo translate('Set Admin Member');?><span class="required">*</span></label>
						<?php echo form_dropdown('admin_member_id',array(''=>'- '.translate('Select').' -'),'','class="form-control m-input--air" id="admin_member_id" '); ?>
					</div>
				</div>
			</div>
					...
					<div class="m-checkbox-inline ">
						<label class="m-checkbox m-checkbox--solid m-checkbox--brand form-control-label">
							...
							<input type="checkbox" name="accept_complete_setup" value="1"> 
								<?php echo translate('I have read and agreed to the terms presented in the Terms and Conditions agreement')?> 
							<span></span>
						</label>
					</div>
				</div>
...
<div class="modal fade" id="view_member_details" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header m--padding-15">
            ...
            <div class="modal-body block_content "style="min-height: 100px;"> 
            	<div class="member_details_holder" style="display: none;">
				    <?php echo form_open_multipart($this->uri->uri_string(), ' class="form_submit m-form m-form--state" role="form" id="edit_member_details"'); ?>
						<div class="form-group m-form__group row pt-0 m--padding-10 ">
							<div class="col-sm-6 m-form__group-sub m-input--air">
								<label><?php echo translate('First Name');?><span class="required">*</span></label>
								<?php echo form_input('first_name','','class="form-control first_name m-input--air" placeholder="First Name" id="first_name"'); ?>
							</div>
							<div class="col-sm-6 m-form__group-sub m-input--air">
								<label><?php echo translate('Last Name');?><span class="required">*</span></label>
								<?php echo form_input('last_name','','class="form-control last_name m-input--air" placeholder="Last Name" id="last_name"'); ?>
							</div>
						</div>
						<?php echo form_hidden('id','');?>
						...
						<div class="form-group m-form__group row pt-0 m--padding-10 ">
							<div class="col-sm-6 m-form__group-sub m-input--air">
								<label><?php echo translate('Phone');?><span class="required">*</span></label>
								<?php echo form_input('phone','','class="form-control phone m-input--air" placeholder="Phone Number" id="phone"'); ?>
							</div>
							<div class="col-sm-6 m-form__group-sub m-input--air">
								<label><?php echo translate('Email Address');?></label>
								<?php echo form_input('email','','class="form-control email m-input--air" placeholder="Email Address" id="email"'); ?>
							</div>
						</div>

						<div class="form-group m-form__group row pt-0 m--padding-10 ">						
							<div class="col-sm-12 m-form__group-sub m-input--air">
								<label><?php echo translate('Group Role');?><span class="required">*</span></label>
								<?php echo form_dropdown('group_role_id',translate($group_roles),'','class="form-control group_role_id m-select2" id="group_role_id" placeholder="Group Role"'); ?>
							</div>						
						</div>
						<div class="m--margin-top-50">
							<div class="col-lg-12 col-md-12">
								<span class="float-lg-right float-md-left float-sm-left float-xl-right">
									<button class="btn btn-primary m-btn m-btn--custom m-btn--icon btn-sm" id="edit_member_button" type="button" >
										<?php echo translate('Save Changes');?>
									</button>
									&nbsp;&nbsp;
									<button class="btn btn-metal m-btn m-btn--custom m-btn--icon btn-sm cancel_form" data-dismiss="modal" type="button" id="cancel_edit_member_form" >
										<?php echo translate('Cancel');?>
									</button>
								</span>
							</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on('click','.edit_member', function(){
        	...
        	if(id){
        		$('#view_member_details').modal('show');
        		$.ajax({
		            type: "POST",
		            data: {id:id},
		            url: "<?php echo site_url('ajax/members/get_member');?>",
		            success: function(response){
		            	if(isJson(response)){
		            		var members = $.parseJSON(response);
		            		$('#view_member_details input[name=first_name]').val(members.data.first_name);
		            		$('#view_member_details input[name=last_name]').val(members.data.last_name);
		            		$('#view_member_details input[name=email]').val(members.data.email);		            		
		            		$('#view_member_details input[name=phone]').val(members.data.phone);
		            		$('#view_member_details input[name=id]').val(id);
		            		$('#view_member_details input[name=user_id]').val(id);		            		
		            		$('#view_member_details select[name=group_role_id]').val(members.data.group_role_id);		            		
		            	}
		            	$('.member_details_holder').slideDown();
		            	mApp.unblock("#view_member_details .modal-body");
		            },
		            error:function(){
		...
		$('#view_member_details').on('shown.bs.modal',function(){
	        mApp.block('#view_member_details .modal-body', {
	            overlayColor: 'grey',
	            animate: true,
	            type: 'loader',
	            state: 'primary',
	            message: 'Fetching Applicant Details
...'
	        });
	    });

	    $('#view_member_details').on('hidden.bs.modal',function(){
	        $('#view_member_details input[name=first_name]').val('');
		    $('#view_member_details input[name=last_name]').val('');
		    $('#view_member_details input[name=email]').val('');		            		
		    $('#view_member_details input[name=phone]').val('');
		    $('#view_member_details input[name=id]').val('');
		    $('#view_member_details input[name=user_id]').val('');
		    $('#view_member_details select[name=group_role_id]').val('');
		    $('.member_details_holder').slideUp();
	    });
        ...
        $(document).on('change','select[name="sacco_id"]',function(){
            ...
            if(sacco_id){
            	...
            	var empty_branch_list = '<option>--Select Group first--</option>';
	                    		...
	                    		$.ajax({
						            ...
						            success: function (t, i, n, r) {
						            	...
						            	if(isJson(t)){
						            		response = $.parseJSON(t);
						            		if(response.status == '1'){
						            			Toastr.show("Group Account Removed",response.message,'success');
						            			load_bank_accounts();
						            		}else if(response.status == '202'){
						            			Toastr.show("Session Expired",response.message,'error');
						            			window.location.href = response.refer;
	    ...
	    $(document).on('keyup','#bank_account_number',function(){
	    	...
	    	if(bank_id == <?php echo $default_bank->id?>){
		    	if(account_number.length == 13){
	                ...
	                (e.addClass("m-loader m-loader--right m-loader--light").attr("disabled", !0),a.ajaxSubmit({
	                	data: {"account_number":account_number,"recipient_bank_id":55},
	                    type: "POST",
	                                ...
	                                setTimeout(function () {
	                                	$.ajax({
								            ...
								            success: function(response2){
		                                        ...
		                                        $('#account_currency').val(""+response2).trigger('change').attr("readonly","readonly");
        ...
        SnippetEditMember.init(false,true);
	});

	function getAccountId(currencyCode=0){
        	...
        	scrollY: "50vh",
           	...
           	columnDefs: [{
				...
				render: function (a, e, t, n) {
					var id = t['5'];
					var member_name = t['1'];
					return '\n                        <span class="dropdown">\n                            <a href="#" class="btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown" aria-expanded="true">\n                              <i class="la la-ellipsis-h"></i>\n                            </a>\n                            <div class="dropdown-menu dropdown-menu-right">\n                                <a class="dropdown-item edit_member" data-id="'+id+'" href="#"><i class="la la-edit"></i> Edit Details</a>\n                                <a class="dropdown-item deldelete_memberete_member" data-id="'+id+'" data-member-name="'+member_name+'" href="#"><i class="la la-trash"></i> Remove Member</a>\n </div>\n                        </span>'
				}
			},{ 
				orderable: !1, 
				targets: [0,2,3,4] 
	...
	function load_group_members(){
		$.ajax({
            ...
            success: function(response){
            	if(isJson(response)){
            		var members = $.parseJSON(response);
            		var html = '<select name="account_signatories[]" class="form-control account_signatories" id="account_signatories" multiple="" data-placeholder="Select...">';
			...
			$(document).on('click',".btn#complete_group_setup",function (t) {
				...
				if(setupIsComplete){
					...
					mApp.block(a, {
	                    ...
	                    type: 'loader',
	                    state: 'primary',
	                    message: 'Submitting Group Setup Data...'
	                });
					RemoveDangerClass(a);
					...
					Toastr.show("Error",'Please ensure you have at least 3 members registered, one contribution setup and one bank account added to complete setup.','error');
				}
			})
		};
		return {
	...
	var SnippetEditMember = function(){
		$("#edit_member_details");
		var t = function (redirect,modal) {
			$(document).on('click',".btn#edit_member_button",function (t) {
				t.preventDefault();
				var e = $(this),
					a = $("#edit_member_details");
				RemoveDangerClass(a);
				(e.addClass("m-loader m-loader--right m-loader--light").attr("disabled", !0),a.ajaxSubmit({
		            type: "POST",
		            url: "<?php echo site_url('ajax/members/edit_members');?>",
		            success: function (t, i, n, r) {
						if(isJson(t)){
							response = $.parseJSON(t);
							if(response.status == '1'){
								setTimeout(function () {
									e.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1),$(".cancel_form").removeAttr("disabled"),
										a.find(".alert").html('').slideUp();
										Toastr.show("Success",response.message,'success');
										$('#cancel_edit_member_form').trigger('click');
								}, 2e3)
							}else if(response.status == '202'){
								Toastr.show("Session Expired",response.message,'error');
								window.location.href = response.refer;
		...
		return {
			init: function (redirect = false,modal = true) {
	            t(redirect,modal)
	        }
		}
	}();
