...
<script type="text/javascript">
    ...
    function load_monthly_balance_sheet(){
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/reports/get_monthly_balance_sheet/'+first_uri_segment+'/'+second_uri_segment+'?'+get_string+'"); ?>',
            dataType : "html",
