                            ...
                            <div class="m-dropdown__content">
                                <?php echo form_open(current_url(),'method="GET" class="filter m-form m-form--label-align-right"');?>
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-12">
                                            <label>
                                                <?php echo translate('Investment Summary Date Range'); ?>
                                            </label>
...
<script type="text/javascript">
    ...
    function load_balance_sheet(){
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/reports/get_investment_statement/'+first_uri_segment+'/'+second_uri_segment+'?'+get_string+'"); ?>',
            dataType : "html",
