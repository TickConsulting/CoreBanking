...
var get_string = "<?php echo $_SERVER['QUERY_STRING']; ?>";
    ...
    function load_expenses_summary(){
        mApp.block('#expenses_summary',{
            overlayColor: 'white',
            animate: true
        });
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/reports/get_expenses_summary/'+first_uri_segment+'/'+second_uri_segment+'?'+get_string+'"); ?>',
            dataType : "html",
