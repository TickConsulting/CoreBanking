<div class="invoice-content-2 bordered document-border">
    ...
    <div id="statement_paper"  class="pt-3">
        <div id="income_statement" class="pt-3">
        </div>
        <hr> 
...
<script type="text/javascript">
    ...
    function load_monthly_income_statement(){
        mApp.block('#income_statement',{
            overlayColor: 'white',
            animate: true
        });
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/reports/get_monthly_income_statement/'+first_uri_segment+'/'+second_uri_segment+'?'+get_string+'"); ?>',
            dataType : "html",
                success: function(response) {
                    $('#income_statement').html(response);
                    $("#statement_footer").slideDown();
                    mApp.unblock('#income_statement');
