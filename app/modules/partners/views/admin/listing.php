	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <?php if(!empty($posts)){ ?>
                    <?php echo form_open('admin/partners/action', ' id="form"  class="form-horizontal"'); ?> 
                            ...
                            <tbody>
                                <?php $i = $this->uri->segment(5, 0); foreach($posts as $post): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $this->application_settings->protocol.$this->application_settings->url."/signup/".$post->slug; ?></td>
                                        <td>
                                            <a href="<?php echo site_url('admin/partners/view/'.$post->id); ?>" class="btn btn-xs blue">
                                                <i class="fa fa-eye"></i> View &nbsp;&nbsp; 
                                            </a>
                                            <a href="<?php echo site_url('admin/partners/edit/'.$post->id); ?>" class="btn btn-xs default">
                                                <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
                                            </a>
                                            <a href="<?php echo site_url('admin/partners/commission_matrix/'.$post->id); ?>" class="btn btn-xs green">
                                                <i class="fa fa-money"></i> Commission Matrix &nbsp;&nbsp; 
                                            </a>
                                        </td>
                                    </tr>
                                    <?php $i++;
