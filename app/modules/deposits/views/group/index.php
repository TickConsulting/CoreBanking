<div class="dash_cont">
    <h4><?php echo translate('Deposits Summary') ?></h4>
    <p><?php echo translate('Your group deposits summary') ?></p>
    <div class="row fin_summ">
        <div class="col-md-4 mt-2 mb-2">
            <div class="fin_summ_entity">
                <div class="fin_summ_title"><?php echo translate('Contributions Payments') ?></div>
                <div class="fin_summ_amount"><span><?php echo $this->group_currency; ?></span><?php echo number_to_currency($total_group_contributions);?></div>
                <div class="fin_summ_descr text-success">
                    <span><i class="mdi mdi-information-outline"></i></span> <?php echo translate('Amount contributed this month') ?>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-2 mb-2">
            <div class="fin_summ_entity">
                <div class="fin_summ_title"><?php echo translate('Fines Payments') ?></div>
                <div class="fin_summ_amount"><span><?php echo $this->group_currency; ?></span> <?php echo number_to_currency($total_group_fines);?></div>
                <div class="fin_summ_descr text-success">
                    <span><i class="mdi mdi-information-outline"></i></span> <?php echo translate('Paid as fines this month') ?>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-2 mb-2">
            <div class="fin_summ_entity">
                <div class="fin_summ_title"><?php echo translate('Miscellaneous Payments') ?></div>
                ...
                <div class="fin_summ_descr text-success">
                    <span><i class="mdi mdi-information-outline"></i></span> <?php echo translate('Other payments made this month') ?>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function load_deposits_dashboard_bank_chart(){
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/reports/get_deposits_summary_graph/"); ?>',
            dataType : "html",
                    ...
                    var contribution_chart_series = new Chart(financial_summary_chart_ctx, {
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                position: 'bottom',
                                text: "<?php echo translate('Total Monthly Deposits') ?>"
                            },
                            elements: {
                                line: {
                                    tension: 0
