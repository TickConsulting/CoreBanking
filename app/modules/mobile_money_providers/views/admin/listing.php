	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <?php if(!empty($posts)){ ?>
                    <?php echo form_open('admin/mobile_money_providers/action', ' id="form"  class="form-horizontal"'); ?> 

                    <?php if ( ! empty($pagination['links'])): ?>
                        <div class="row col-md-12">
                            <p class="paging">Showing from <span class="greyishBtn"><?php echo $pagination['from']; ?></span> to <span class="greyishBtn"><?php echo $pagination['to']; ?></span> of <span class="greyishBtn"><?php echo $pagination['total']; ?></span> Mobile_money_providers</p>
                        <?php 
                            ...
                            <tbody>
                                <?php $i = $this->uri->segment(5, 0); foreach($posts as $post): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $post->country_id?$country_options[$post->country_id]:'<span class="label label-primary">--Not Set--</span>';?></td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('admin/mobile_money_providers/edit/'.$post->id); ?>" class="btn btn-xs default">
                                                <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
                                            </a>
                                            <?php if($post->active){ ?>
                                                <a href="<?php echo site_url('admin/mobile_money_providers/hide/'.$post->id); ?>" class="btn btn-xs default confirmation_link">
                                                    <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
                                                </a>
                                            <?php }else{ ?>
                                                <a href="<?php echo site_url('admin/mobile_money_providers/activate/'.$post->id); ?>" class="btn btn-xs green confirmation_link">
                                                    <i class="icon-eye"></i> Activate &nbsp;&nbsp; 
                                                </a>
                                            <?php } ?>
                                            <a href="<?php echo site_url('admin/mobile_money_provider_branches/create/'.$post->id); ?>" class="btn btn-xs green">
                                                <i class="fa fa-plus-square-o"></i> Create Branch &nbsp;&nbsp; 
                                            </a>

                                            <a href="<?php echo site_url('admin/mobile_money_provider_branches/import/'.$post->id); ?>" class="btn btn-xs blue">
                ...
                <?php }else{ ?>
                    <div class="alert alert-info">
                        ...
                        <p>
                            No Mobile money providers to display.
                        </p>
                    </div>
                <?php } ?>
            </div>
