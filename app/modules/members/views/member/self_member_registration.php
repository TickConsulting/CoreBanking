			...
			<div class="m-login__body">
				...
				<div class="m-login__signin">
					<div class="m-login__title">
						<h4><?php echo translate('Register to join ');?> <?php echo $group_name; ?></h4>
						<p><?php echo translate('Fill in the following credentials');?></p>
					</div>
					...
					<?php echo form_open(site_url('ajax/login'),'class="m-login__form m-form m-form--state" autocomplete="off"');?>
						<div class="form-group m-form__group cust_login_inputs">
							<input class="form-control m-input--air cust_login_username" id="full_name" type="text" placeholder="Your Full Name" name="fullname" autocomplete="off" autofocus>
							<label for="fullname"><?php echo translate('Full Name');?></label>
						</div>
						<div class="form-group m-form__group cust_login_inputs">
							<input class="form-control m-input--air cust_login_username" id="phome" type="text" placeholder="Your Phone Number" name="phone" autocomplete="off" autofocus>
							<label for="phone"><?php echo translate('Phone Number');?></label>
						</div>
						<div class="form-group m-form__group cust_login_inputs">
							<input class="form-control m-input--air cust_login_username" id="email" type="text" placeholder="Your Email" name="email" autocomplete="off" autofocus>
							<label for="email"><?php echo translate('Email');?></label>
						</div>
						<div class="m-login__action mt-2 mb-3">
							<button type="submit" id="m_login_signin_submit" class="btn cust_checkin_btn btn-success m-btn m-btn--outline-2x m-login__btn" disabled="disabled"><?php echo translate('Request Membership');?></button>
						</div>
					</form>
					<!--end::Form-->
