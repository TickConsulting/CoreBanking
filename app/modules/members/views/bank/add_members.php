    ...
    <table class="table table-checkable member-table table-condensed" id="multiple-entries">
        <thead>
            <tr>
                ...
                <th width="20%"><?php echo translate('ID Number');?> <span class="required">*</span></th>
                <th width="5%"><?php echo translate('Loan Limit'); ?></th>
                <th width="5%">&nbsp;</th>
            </tr>
        </thead>
        <tbody id="append-place-holder">
            <tr>
                ...
                <td>
                <?php echo form_input('id_numbers[]','','class="form-control form-control-sm m-input m-input--air id_numbers lowercase" placeholder=""');?>
                ...
                <td>
                    <span class="m-select2-sm m-input--air">
                    <?php echo form_input('limits[]','','class="form-control form-control-sm m-input m-input--air limits currency lowercase" placeholder=""');?>
                    </span>
                </td>
                <td class="text-right">
    ...
    <div class="m-form__actions m-form__actions p-0 pt-2 m--margin-top-10">
        <a href="javascript:;" class="btn btn-default btn-sm margin-right-10 add-new-line" id="add-new-line">
            ...
            <span class="hidden-380">
                <?php echo translate('Add new User line');?>
            </span>
        </a>
    </div>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>
                    <span class="m-select2-sm m-input--air">
                    <?php echo form_input('id_numbers[]','','class="form-control form-control-sm m-input m-input--air email_addresses lowercase" placeholder=""');?>
                    </span>
                </td>
                
                <td>
                    <span class="m-select2-sm m-input--air">
                    <?php echo form_input('limits[]','','class="form-control form-control-sm m-input m-input--air limits lowercase" placeholder=""');?>
                    </span>
                </td>
                <td class="text-right">
                    <a href='javascript:;' class="remove-line">
