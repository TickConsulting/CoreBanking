...
class Member extends Member_Controller
{
    ...
    function __construct()
    {
        ...
        if($this->group->disable_member_directory){
            $this->members = array('info@chamasoft.com'=>$this->application_settings->application_name.' Team');
        ...
        $this->message_template = 'Dear [NAME],<br/><br/><br/><br/><br/><br/>Regards,<br/>'.$this->user->first_name.' '.$this->user->last_name.'.';
    ...
    function index(){
        ...
        $this->template->title(translate('Emails'))->set_layout('member_default.html')->build('shared/form',$this->data);
    }
                    ...
                    foreach ($posts as $post) 
                    {
                        ...
                        $html.='<tr data-messageid="'.$post->id.'" style="cursor:pointer;">
                            ...
                            $html.='<tr><td colspan="6" style="background:#fff!important;border: none;"><div class="alert m-alert--outline alert-metal">
                                        ...
                                        <p>
                                            '.translate('There are no emails in outbox').'.
                                        </p>
                                    </div></td></tr>';
                    ...
                    <tr>
                        <td colspan="6" style="background:#fff!important;border: none;">
                            <div class="alert m-alert--outline alert-metal">
                                <h4 class="block">'.translate('Information').'! '.translate('No records to display').'</h4>
                                <p>
                                    '.translate('There are no draft emails').'.
                                </p>
                            </div>
                        </td>
                    </tr>
            ...
            <table class="table table-striped table-advance table-hover">';
                    ...
                    foreach ($posts as $post) 
                    {
                        ...
                        $html.='<tr data-messageid="'.$post->id.'">
                                    <td class="inbox-small-cells">
                                        <input type="checkbox" class="mail-checkbox" name="list-mails[]" value="'.$post->id.'"> 
                                    </td>
                                    <td class="inbox-small-cells">';
                                        if($this->user->email == $post->email_to){
                                                $html.='<i class="fa fa-star inbox-started"></i>';
                                            }else{
                                    ...
                                    if($member_email_to){
                                        ...
                                        $html.='<td class="view-sent-message hidden-xs">Chamasoft</td>';
                                    }
    ...
    function app_app_inbox(){
        ...
        $html= '<table class="table table-striped table-advance table-hover">';
            ...
            $html.= '<thead>
                        <tr>';
                            $html.=form_open(site_url('member/emails/action'));
                            $html.='<th colspan="3">
                                <label class="m-checkbox m-checkbox--bold">
                                    <input type="checkbox" class="mail-checkbox mail-group-checkbox">
                                    <span></span>
    ...
    function view($id=0){
        $this->template->title('Emails')->set_layout('member_default.html')->build('shared/form',$this->data);
    }


    function compose(){
        $html= form_open_multipart(site_url('member/emails/create'),'class="inbox-compose form-horizontal form_submit" id="fileupload"');
        $html.='
            ...
            <div class="inbox-view-info">
                <div class="row">
                    ...
                    if($member_email_from){
                        ...
                        $html.='<span class="sbold">Chamasoft</span>';
                    }
            ...
            $html.='<div class="inbox-compose-btn">
                ...
                <div class="inbox-form-group mail-to">
                    ...
                    if($member_email_from){
                        ...
                        $html.=form_dropdown('member_id_to[]',array('info@chamasoft.com'=>'Chamasoft Team')+$this->members,'info@chamasoft.com','class="form-control member_id_to select2-multiple" multiple id="multiple"');
                    }
    ...
    function send_draft($id=0){
        if(!$id){
            ...
            $this->emails_m->update_queue($id,array('is_draft'=>''));
            return TRUE;
        }
    }
