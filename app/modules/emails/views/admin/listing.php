        ...
        <div class="portlet light bordered">
            ...
            <?php if ( ! empty($pagination['links'])): ?>
                <div class="row col-md-12">
                    <p class="paging">Showing from <span class="greyishBtn"><?php echo $pagination['from']; ?></span> to <span class="greyishBtn"><?php echo $pagination['to']; ?></span> of <span class="greyishBtn"><?php echo $pagination['total']; ?></span> Emails</p>
                <?php 
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td >
                                    <a href="<?php echo site_url('admin/emails/view/'.$post->id);?>" class="btn btn-xs default">
