    ...
    <fieldset>
        ...
        <div class="form-group m-form__group row pt-0 m--padding-10" id="member_to_amount_holder" style="display: none;">
            ...
            <div class="col-sm-6 m-form__group-sub m-input--air " id="member_ids">
                ...
                <?php echo form_dropdown('member_id',array(''=>translate('Select Member to Create Loan'))+translate($active_group_member_options),$this->input->post('member_id')?:$post->member_id?:'',' class="form-control m-input m-select2 member_id" id="member_id" ');?>
            </div>
