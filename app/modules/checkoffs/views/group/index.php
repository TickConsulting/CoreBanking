...
<div class="dash_cont wallet_summary">
    <h4>Checkoff Summary</h4>
    <div class="row fin_summ">
        <div class="col-md-12 mt-2 mb-2">
            <div class="row">
                <div class="col-md-6">
                    <div class="fin_summ_entity">
                        <div class="fin_summ_title"><?php echo translate('Total Set Checkoff Amount');?></div>
                        <div class="fin_summ_amount"><span><?php echo $this->group_currency; ?> </span><?php echo number_to_currency($total_checkoff);?></div>
                        <div class="fin_summ_descr text-success">
                            <span><i class="mdi mdi-information-outline"></i></span><?php echo translate('Total Checkoff amount set');?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="fin_summ_entity">
                        <div class="fin_summ_title">Members set Checkoff</div>
                        <div class="fin_summ_amount"><span></span> <?php echo $set_members.' Members';?></div>
                        <div class="fin_summ_descr text-success">
                            <span><i class="mdi mdi-cash-multiple"></i></span> <?php echo translate('Members who have set checkoff');?>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function load_deposits_dashboard_bank_chart(){
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("ajax/checkoffs/get_monthly_checkoff_summary"); ?>',
            dataType : "html",
