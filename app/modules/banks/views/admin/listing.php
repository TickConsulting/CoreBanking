                ...
                <?php if(!empty($posts)){ ?>
                    ...
                    <?php if ( ! empty($pagination['links'])): ?>
                                ...
                                <?php $i = $this->uri->segment(5, 0); foreach($posts as $post): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if($post->default_bank){
                                                echo "<span class='label label-success'>Default</span>";
                                            }
                                            ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if($post->default_bank){?>
                                                <a href="<?php echo site_url('admin/banks/remove_as_default/'.$post->id); ?>" class="btn btn-xs default confirmation_link">
                                                    <i class="icon-pencil"></i> Remove As Default &nbsp;&nbsp; 
                                                </a>
                                            <?php }else{ ?>
                                                <a href="<?php echo site_url('admin/banks/set_as_default/'.$post->id); ?>" class="btn btn-xs default">
                                                    <i class="icon-pencil"></i> Set As Default &nbsp;&nbsp; 
                                                </a>
                                            <?php } ?>
                                            <a href="<?php echo site_url('admin/banks/edit/'.$post->id); ?>" class="btn btn-xs default">
                                                <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
                                            </a>
                                            <?php if($post->active){ ?>
                                                <a href="<?php echo site_url('admin/banks/hide/'.$post->id); ?>" class="btn btn-xs default confirmation_link">
                                                    <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
                                                </a>
                                            <?php }else{ ?>
                                                <a href="<?php echo site_url('admin/banks/activate/'.$post->id); ?>" class="btn btn-xs green confirmation_link">
                                                    <i class="icon-eye"></i> Activate &nbsp;&nbsp; 
                                                </a>
                                            <?php } ?>
                                            <!--
                                            <a href="<?php echo site_url('admin/banks/delete/'.$post->id); ?>" class="btn btn-xs red confirmation_link">
                                                    <i class="fa fa-remove"></i> Delete &nbsp;&nbsp; 
                                                </a>
                                            -->
                                            <a href="<?php echo site_url('admin/bank_branches/create/'.$post->id); ?>" class="btn btn-xs green">
                                                <i class="fa fa-plus-square-o"></i> Create Branch &nbsp;&nbsp; 
                                            </a>

                                            <a href="<?php echo site_url('admin/bank_branches/import/'.$post->id); ?>" class="btn btn-xs blue">
                                                <i class="fa fa-cloud-upload"></i> Import Branches &nbsp;&nbsp; 
                                            </a>
                                            <a href="<?php echo site_url('admin/bank_branches/listing?bank_id='.$post->id); ?>" class="btn btn-xs blue">
                                                <i class="fa fa-list-ul"></i> List Branches &nbsp;&nbsp; 
                                            </a>
                                        </td>
                                    </tr>
                                    <?php $i++;
                        ...
                        <?php if($posts):?>
                            ...
                            <!--
                                <button class="btn btn-sm btn-danger confirmation_bulk_action" name='btnAction' value='bulk_delete' data-toggle="confirmation" data-placement="top"> <i class='fa fa-remove'></i> Bulk Delete</button>
                            -->
                        <?php endif;?>
                    <?php echo form_close(); ?>
                <?php }else{ ?>
