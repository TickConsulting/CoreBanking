	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <div id="sort">
                    <div class="dd" id="settings_menu_sort">
                        <ol class="dd-list">
                            ...
                            <?php foreach($posts as $post): ?>
                                <li class="dd-item" data-id="<?php echo $post->id?>">
                                    ...
                                    <?php $this->member_settings_menus_m->display_children($post->id); ?>
                                </li>
                            <?php endforeach;?>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea id="settings_menu_sort_output" class="form-control col-md-12 margin-bottom-10"></textarea>
                    </div>
                </div>
            </div>
