    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            ?> 
                ...
                <table class="table table-bordered table-condensed table-striped table-hover table-header-fixed table-searchable">groups
                    <thead>
                        <tr>
                            <th>
                                #
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php 
                                    if($post->group_id){
                                        echo isset($groups[$post->group_id])?$groups[$post->group_id]:'';
                                    }
                                ?></td>
