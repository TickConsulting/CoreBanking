	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
				<?php if(!empty($posts)){ ?>
			        <?php echo form_open('admin/partner_menus/action', ' id="form"  class="form-horizontal"'); ?> 
		                    ...
		                    <tbody>
		                        <?php foreach($posts as $post): ?>
		                            <tr>
		                                ...
		                                <td>
		                                    <a href="<?php echo site_url('admin/partner_menus/edit/'.$post->id); ?>" class="btn btn-xs default">
		                                        <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                    </a>
		                                    <?php if($post->active){ ?>
		                                        <a href="<?php echo site_url('admin/partner_menus/hide/'.$post->id); ?>" class="btn btn-xs white">
		                                            <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                        </a>
		                                    <?php }else{ ?>
		                                        <a href="<?php echo site_url('admin/partner_menus/activate/'.$post->id); ?>" class="btn btn-xs green">
		                                            <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                        </a>
		                                    <?php } ?>
		                                    <a href="<?php echo site_url('admin/partner_menus/delete/'.$post->id); ?>" class="btn btn-xs red confirmation_link">
		                            ...
		                            $children = $this->partner_menus_m->get_children_links($post->id);
		                                if(!empty($children)):
		                            ...
		                            ?>
		                                <tr>
		                                    ...
		                                    <td>
		                                        <a href="<?php echo site_url('admin/partner_menus/edit/'.$child->id); ?>" class="btn btn-xs default">
		                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                        </a>
		                                        <?php if($child->active){ ?>
		                                            <a href="<?php echo site_url('admin/partner_menus/hide/'.$child->id); ?>" class="confirmation_link btn btn-xs white">
		                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                            </a>
		                                        <?php }else{ ?>
		                                            <a href="<?php echo site_url('admin/partner_menus/activate/'.$child->id); ?>" class=" confirmation_link btn btn-xs green">
		                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                            </a>
		                                        <?php } ?>
		                                        <a href="<?php echo site_url('admin/partner_menus/delete/'.$child->id); ?>" class="btn btn-xs red confirmation_link">
		                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
		                                        </a>
		                                    </td>
		                                </tr>
		                                ...
		                                $grand_children = $this->partner_menus_m->get_children_links($child->id);
		                            ...
		                            <tr>
		                                    ...
		                                    <td>
		                                        <a href="<?php echo site_url('admin/partner_menus/edit/'.$grand_child->id); ?>" class="btn btn-xs default">
		                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                        </a>
		                                        <?php if($grand_child->active){ ?>
		                                            <a href="<?php echo site_url('admin/partner_menus/hide/'.$grand_child->id); ?>" class="btn btn-xs white confirmation_link">
		                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                            </a>
		                                        <?php }else{ ?>
		                                            <a href="<?php echo site_url('admin/partner_menus/activate/'.$grand_child->id); ?>" class="btn btn-xs green confirmation_link">
		                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                            </a>
		                                        <?php } ?>
		                                        <a href="<?php echo site_url('admin/partner_menus/delete/'.$grand_child->id); ?>" class="btn btn-xs red confirmation_link ">
		                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
		                                        </a>
		                                    </td>
		                                </tr>
