                                ...
                                <?php echo form_open_multipart($this->uri->uri_string(), ' class="form_submit m-form m-form--state" role="form" id="create_loan_type"'); ?>
                                    <div class="form-group m-form__group row pt-0 m--padding-10">
                                        ...
                                        <div class="col-sm-6 m-form__group-sub m-input--air">
                                            <label><?php echo translate('Loan Amount Type');?> (Eg. Based on member Savings)<span class="required">*</span></label>
                                             <?php echo form_dropdown('loan_amount_type',array(''=>'--'.translate('Select Loan Amount Type').'--')+translate($loan_amount_type),$this->input->post('loan_amount_type')?$this->input->post('loan_amount_type'):$post->loan_amount_type,'class="select2 form-control " id ="loan_amount_type" data-placeholder="Select..."  ');?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group interest_type_input_group pt-0 m--padding-10">
                                        <div class="row">
                                            <div class="col-sm-4 m-form__group-sub">
                                                ...
                                                <?php echo form_dropdown('interest_type',array(''=>'--Select Loan Interest Type--')+$interest_types,$this->input->post('interest_type')?$this->input->post('interest_type'):$post->interest_type,'class="form-control select2 interest_type" id = "interest_type"  ');?>
                                            </div>
                                                ...
                                                <div class="not_for_custom_settings">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 m-form__group-sub m-input--air">
                                                            ...
                                                            <?php echo form_dropdown('loan_interest_rate_per',translate($loan_interest_rate_per),$this->input->post('loan_interest_rate_per')?$this->input->post('loan_interest_rate_per'):$post->loan_interest_rate_per,'class="form-control select2 interest_type" id = "loan_interest_rate_per"  ') ?>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="m-form__group form-group row pt-0 m--padding-10" id="grace_period">
                                        <div class="col-sm-12 m-form__group-sub m-input--air">
                                            ...
                                            <?php echo form_dropdown('grace_period',array(''=> '--Select Loan Grace Period--')+translate($loan_grace_periods)+array('date'=>translate("Custom Date")),$post->grace_period,'class="form-control select2 grace_period" id = "grace_period"  ') ?>
                                        </div>
                                    </div> 
                                            ...
                                            <div class="enable_loan_fines_settings">
                                                <div class="m-form__group form-group row loan_fine_type pt-0 m--padding-10">
                                                    <div class="m-form__group-sub m-input--air col-sm-12 m-input--air">
                                                        ...
                                                        <?php echo form_dropdown('loan_fine_type',array(''=>'--Select  the Type of Fine Charged--')+translate($late_loan_payment_fine_types),$this->input->post('loan_fine_type')?$this->input->post('loan_fine_type'):$post->loan_fine_type,'class="form-control select2 loan_fine_type" id = "loan_fine_type"  ') ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="late_loan_payment_percentage_fine">
                                                    <div class="m-form__group form-group row pt-0 m--padding-10">
                                                        ...
                                                        <div class="m-form__group-sub m-input--air col-sm-4">
                                                            ...
                                                            <?php echo form_dropdown('percentage_fine_frequency',array(''=>'--Select  the fine frequecy--')+translate($late_payments_fine_frequency),$this->input->post('percentage_fine_frequency')?$this->input->post('percentage_fine_frequency'):$post->percentage_fine_frequency,'class="form-control select2 percentage_fine_frequency" id = "percentage_fine_frequency"  ') ?>
                                                        </div>

                                                        <div class="m-form__group-sub m-input--air col-sm-4">
                                                            <label><?php echo translate('Fine Charge on');?> <span class="required">*</span></label>
                                                            <?php echo form_dropdown('percentage_fine_on',array(''=>'--Select where is Fine Charged On--')+translate($percentage_fine_on),$this->input->post('percentage_fine_on')?$this->input->post('percentage_fine_on'):$post->percentage_fine_on,'class="form-control select2 percentage_fine_on" id = "percentage_fine_on"  ') ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="late_loan_repayment_one_off_fine">
                                                    <div class="m-form__group form-group row pt-0 m--padding-10">
                                                        <div class="m-form__group-sub col-sm-4 m-input--air">
                                                            ...
                                                            <?php echo form_dropdown('one_off_fine_type',array(''=>'--Select one Off fine Type--')+translate($one_off_fine_types),$this->input->post('one_off_fine_type')?$this->input->post('one_off_fine_type'):$post->one_off_fine_type,'class="form-control select2 one_off_fine_type" id = "one_off_fine_type"  ') ?>
                                                        </div>
                                                                ...
                                                                <div class="one_off_percentage_setting">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="m-form__group-sub col-sm-6 m-input--air">
                                                                            ...
                                                                            <?php echo form_dropdown('one_off_percentage_rate_on',array(''=>'--Select One Off Percentage on--')+translate($one_off_percentage_rate_on),$this->input->post('one_off_percentage_rate_on')?$this->input->post('one_off_percentage_rate_on'):$post->one_off_percentage_rate_on,'class="one_off_percentage_rate_on form-control select2" id = "one_off_percentage_rate_on"  ') ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="m-form__group form-group pt-0 m--padding-10">
                                                    <div class="row">
                                                        <div class="m-form__group-sub col-sm-4">
                                                            ...
                                                            <?php echo form_dropdown('loan_processing_fee_type',array(''=>'--Select Type--')+translate($loan_processing_fee_types),$this->input->post('loan_processing_fee_type')?$this->input->post('loan_processing_fee_type'):$post->loan_processing_fee_type,'class="form-control select2 loan_processing_fee_type" id = "loan_processing_fee_type"  ') ?>
                                                        </div>
                                                        <div class="m-form__group-sub col-sm-8">
                         ...
                         <div class="col-lg-12 m-form__group-sub">
                            ...
                            <!-- end of limit to one  loan application -->
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn blue submit_form_button">Save loan type</button>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click','#cancel_create_loan_type_form',function(){
            ...
            $(".create_loan_type_setting .select2").select2({
                width: "100%",
                placeholder: {
                    id: '-1',
                    text: "--Select option--",
       ...
       <?php } ?>
        ...
        <?php if($this->input->post('loan_processing_fee_type') || $post->loan_processing_fee_type){?>
            $('select[name="loan_processing_fee_type"]').trigger('change');
        <?php }?>
