                ...
                <?php echo form_open_multipart(current_url(),'class="form_submit" role="form"');?>
                    <div class="form-body">
                        <div class="form-group">
                            <label>Sacco Name<span class="required">*</span></label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa  fa-bank"></i>
                                </span>
                                <?php echo form_input('name',$this->input->post('name')?$this->input->post('name'):$post->name,'class="form-control" placeholder="Sacco Name"');?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="logo" class="">Sacco Logo</label>
                            <div class="input-group">
                                <input type="file" name="logo">
                                <p class="help-block"> Upload Sacco Logo Here </p>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <label class="checkbox-inline"><?php echo form_checkbox('partner',1,$this->input->post('partner')?$this->input->post('partner'):$post->partner,'class="form-control" placeholder="Chamasoft Partner"');?> Sacco is a Chamasoft Partner</label>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <input type="submit" class="btn btn-primary submit_form_button" name="new_item" value="Save Changes and Create New Sacco"/>
