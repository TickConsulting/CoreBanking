	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <?php }else{ ?>
                    <?php echo form_open('admin/billing/configuration_action', ' id="form"  class="form-horizontal"'); ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                    echo "<a class='btn blue btn-xs' href='".site_url('admin/billing/edit_safaricom_configuration/'.$post->id)."'><i class='fa fa-edit'></i> Edit </a>";
                                                    echo '&nbsp;&nbsp;';
                                                    echo "<a class='btn red btn-xs confirmation_link' href='".site_url('admin/billing/delete_configuration/'.$post->id)."'><i class='icon-trash'></i> Delete </a>";
                                                ?>
                                            </td>
                                        </tr>
                                    <?php 
