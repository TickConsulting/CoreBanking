            ...
            <div class="portlet-body form">
                <?php echo form_open(current_url(),'class="form_submit" role="form"');?>
                    <div class="form-body">
                        ...
                        <!-- <div class="form-group">
                            <label>Menu Language Key<span class="required">*</span></label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa  fa-file-text-o"></i>
                                </span>
                                <?php echo form_input('language_key',$post->language_key?$post->language_key:'','class="form-control" placeholder="Menu Language Key"');?>
                            </div>
                        </div> -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo form_input('description',$post->description?$post->description:'','class="form-control" placeholder="Menu Description"');?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('enable_menu_for',array(''=>'All Users', 1 => 'Specific Users'),$post->enable_menu_for?:'','class="form-control select2" placeholder="Select Menu Parent"');?>
                        </div>
