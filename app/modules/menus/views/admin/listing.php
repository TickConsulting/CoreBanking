	...
	<div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
				<?php if(!empty($posts)){ ?>
			        <?php echo form_open('admin/menus/action', ' id="form"  class="form-horizontal"'); ?> 
		                    ...
		                    <tbody>
		                        <?php foreach($posts as $post): ?>
		                            <tr>
		                                ...
		                                <td>
		                                    <a href="<?php echo site_url('admin/menus/edit/'.$post->id); ?>" class="btn btn-xs default">
		                                        <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                    </a>
		                                    <?php if($post->active){ ?>
		                                        <a href="<?php echo site_url('admin/menus/hide/'.$post->id); ?>" class="btn btn-xs white">
		                                            <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                        </a>
		                                    <?php }else{ ?>
		                                        <a href="<?php echo site_url('admin/menus/activate/'.$post->id); ?>" class="btn btn-xs green">
		                                            <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                        </a>
		                                    <?php } ?>
		                                    <a href="<?php echo site_url('admin/menus/delete/'.$post->id); ?>" class="btn btn-xs red confirmation_link">
		                            ...
		                            ?>
		                                <tr>
		                                    ...
		                                    <td>
		                                        <a href="<?php echo site_url('admin/menus/edit/'.$child->id); ?>" class="btn btn-xs default">
		                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                        </a>
		                                        <?php if($child->active){ ?>
		                                            <a href="<?php echo site_url('admin/menus/hide/'.$child->id); ?>" class="confirmation_link btn btn-xs white">
		                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                            </a>
		                                        <?php }else{ ?>
		                                            <a href="<?php echo site_url('admin/menus/activate/'.$child->id); ?>" class=" confirmation_link btn btn-xs green">
		                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                            </a>
		                                        <?php } ?>
		                                        <a href="<?php echo site_url('admin/menus/delete/'.$child->id); ?>" class="btn btn-xs red confirmation_link">
		                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
		                                        </a>
		                                    </td>
		                                </tr>
		                            ...
		                            <tr>
		                                    ...
		                                    <td>
		                                        <a href="<?php echo site_url('admin/menus/edit/'.$grand_child->id); ?>" class="btn btn-xs default">
		                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
		                                        </a>
		                                        <?php if($grand_child->active){ ?>
		                                            <a href="<?php echo site_url('admin/menus/hide/'.$grand_child->id); ?>" class="btn btn-xs white confirmation_link">
		                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
		                                            </a>
		                                        <?php }else{ ?>
		                                            <a href="<?php echo site_url('admin/menus/activate/'.$grand_child->id); ?>" class="btn btn-xs green confirmation_link">
		                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
		                                            </a>
		                                        <?php } ?>
		                                        <a href="<?php echo site_url('admin/menus/delete/'.$grand_child->id); ?>" class="btn btn-xs red confirmation_link ">
		                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
		                                        </a>
		                                    </td>
		                                </tr>
		                            ...
		                            <?php 
		                            	$great_grand_children = $this->menus_m->get_children_links($grand_child->id);
		                            	if($great_grand_children):
		                            		foreach ($great_grand_children as $great_grand_child):?>
		                            			<tr>
				                                    ...
				                                    <td>
				                                        <a href="<?php echo site_url('admin/menus/edit/'.$great_grand_child->id); ?>" class="btn btn-xs default">
				                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
				                                        </a>
				                                        <?php if($great_grand_child->active){ ?>
				                                            <a href="<?php echo site_url('admin/menus/hide/'.$great_grand_child->id); ?>" class="btn btn-xs white confirmation_link">
				                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
				                                            </a>
				                                        <?php }else{ ?>
				                                            <a href="<?php echo site_url('admin/menus/activate/'.$great_grand_child->id); ?>" class="btn btn-xs green confirmation_link">
				                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
				                                            </a>
				                                        <?php } ?>
				                                        <a href="<?php echo site_url('admin/menus/delete/'.$great_grand_child->id); ?>" class="btn btn-xs red confirmation_link ">
				                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
				                                        </a>
				                                    </td>
				                                </tr>
				                    <?php 
				                       $great_grand_grand_children = $this->menus_m->get_children_links($great_grand_child->id);
				                       if($great_grand_grand_children):
				                       		foreach ($great_grand_grand_children as $great_grand_grand_child):?>
				                       			<tr>
				                                    ...
				                                    <td>
				                                        <a href="<?php echo site_url('admin/menus/edit/'.$great_grand_grand_child->id); ?>" class="btn btn-xs default">
				                                            <i class="icon-pencil"></i> Edit &nbsp;&nbsp; 
				                                        </a>
				                                        <?php if($great_grand_grand_child->active){ ?>
				                                            <a href="<?php echo site_url('admin/menus/hide/'.$great_grand_grand_child->id); ?>" class="btn btn-xs white confirmation_link">
				                                                <i class="fa fa-eye-slash"></i> Hide &nbsp;&nbsp; 
				                                            </a>
				                                        <?php }else{ ?>
				                                            <a href="<?php echo site_url('admin/menus/activate/'.$great_grand_grand_child->id); ?>" class="btn btn-xs green confirmation_link">
				                                                <i class="fa fa-eye"></i> Activate &nbsp;&nbsp; 
				                                            </a>
				                                        <?php } ?>
				                                        <a href="<?php echo site_url('admin/menus/delete/'.$great_grand_grand_child->id); ?>" class="btn btn-xs red confirmation_link ">
				                                            <i class="icon-trash"></i> Delete &nbsp;&nbsp; 
				                                        </a>
				                                    </td>
				                                </tr>	
