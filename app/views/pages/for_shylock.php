            ...
            <div class="container-fluid pt-2">
                <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-12 ftco-animate text-left" data-scrollax=" properties: { translateY: '70%' }">
                        ...
                        <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo $this->application_settings->application_name; ?> <?php echo translate('for Mr. Shylock'); ?></h1>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex align-items-center pb-5">
                        <div class="feature-cont">
                            <p>If you have some money which you would like to lend to other people, you can create your account online and start lending within no time.</p>
                            <p>Of course, most of your clients will feel  like they are bird watching in lion country- after being bitten where it hurts most- their pockets- by your exorbitant interest rates- but God is watching you nick pennies from the penniless…without shame, go ahead and use our system. Selah!</p>
                            <p></p>
                        </div>
                    </div>
                </div>
