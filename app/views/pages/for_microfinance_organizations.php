            ...
            <div class="container-fluid pt-2">
                <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-12 ftco-animate text-left" data-scrollax=" properties: { translateY: '70%' }">
                        ...
                        <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo $this->application_settings->application_name; ?> <?php echo translate('for microfinance organizations'); ?></h1>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex align-items-center pb-5">
                        <div class="feature-cont">
                            <p>Is your microfinance organization looking for a robust digital platform that will help you become a paperless digital lender?</p>
                            <p>Look no further. If you operate in rural areas with low internet., enjoy our platform offline mode which means that  you will have a fully functional platform which will upload to your online cloud server once your have your connection back.</p>
                            <p></p>
                        </div>
                    </div>
                </div>
