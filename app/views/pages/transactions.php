            ...
            <div class="container-fluid pt-2">
                <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-12 ftco-animate text-left" data-scrollax=" properties: { translateY: '70%' }">
                        ...
                        <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo translate('Transactions'); ?></h1>
                        <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="margin-top:-20px;">Manage your Group transactions easily</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12 d-flex align-items-center pb-5">
                        <div class="feature-cont">
                            ...
                            <p>
                                ...
                                2. Group withdrawal transactions.<br>
                                3. Account to account transfers<br>
                                4. Receive and reconcile transaction alerts directly from your bank.<br>
                            </p>
                        </div>
                    </div>
                </div>
