			...
			<div class="m-login__body">
				...
				<div class="m-login__signin">
					<div class="m-login__title">
						<h4><?php echo translate('Confirmation Code');?></h4>
						<p><?php echo translate('Use the code sent to your registered Email or Phone');?></p>
					</div>
					...
					<?php echo form_open(site_url('ajax/forgot_password'),'class="m-login__form m-form m-form--state" autocomplete="off"');?>
						...
						<div class="">
							<div class="form-group m-form__group cust_login_inputs">
								<input class="form-control m-input--air cust_login_username" id="cust_login_username" type="text" placeholder="Phone number or email" value="<?php echo $this->input->get('identity');?>" name="identity" autocomplete="off">
								<label for="cust_login_username"><?php echo translate('Email or Phone');?></label>
							</div>
							<div class="form-group m-form__group cust_login_inputs">
								<input class="form-control m-input--air cust_login_username" id="cust_confirm_code" type="text" placeholder="Confirmation code" name="code" autocomplete="off" autofocus>
								<label for="cust_confirm_code"><?php echo translate('Confirmation Code');?></label>
							</div>
							<div class="m-login__action text-left">
								<a href="<?php echo site_url('forgot_password') ?>" class="m-link cust_link second_button">
									<span><?php echo translate('Resend confirmation code');?> ?</span>
								</a>
							</div>
						</div>
	...
	var SnippetRecoverPassword = function () {
		var t = function () {
			$("#recover_password_submit_btn").click(function (t) {
		        ...
		        $.post({
					url: "<?php echo site_url('ajax/confirm_code');?>",
