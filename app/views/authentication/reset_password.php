					...
					<?php echo form_open(site_url('ajax/forgot_password'),'class="m-login__form m-form m-form--state" autocomplete="off"');?>
						<div class="">
							<div class="form-group m-form__group cust_login_inputs">
								<input class="form-control m-input--air cust_new_pass" id="cust_new_pass" type="password" placeholder="Your new password" autocomplete="off" name="password" autofocus>
						...
						<div class="row mb-5 mt-3">
							<div class="col-12">
								<button type="submit" id="recover_password_submit_btn" class="btn cust_checkin_btn btn-success m-btn m-btn--outline-2x mt-3 mr-2"><i class="la la-check"></i> <?php echo translate('Submit');?></button>
		...
		var t = function () {
			$("#recover_password_submit_btn").click(function (t) {
				...
				var e = $(this),
					a = $(".m-login__form");
				var s = $(".second_button");
				codeData = {name: "code",value:"<?php echo $this->input->get_post('code');?>"};
				var formData = a.serializeArray();
				...
				$.post({
					data : encryptdata(passphrase,formData),
