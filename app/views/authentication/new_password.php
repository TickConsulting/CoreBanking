				...
				<div class="m-login__signin">
					...
					<?php echo form_open(site_url('ajax/set_new_password'),'class="m-set_new_password_form m-form m-form--state" autocomplete="off"');?>
						...
						<div class="row mb-5 mt-3">
							<div class="col-12">
								<button type="submit" id="new_password_submit_btn" class="btn cust_checkin_btn btn-success m-btn m-btn--outline-2x mt-3 mr-2" ><?php echo translate('Submit');?> <i class="la la-angle-right"></i></button>
							</div>
						</div>
					</form> 
					<!--end::Form-->
