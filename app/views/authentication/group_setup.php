	...
	<div id="create_group_panel">
		<div class="m-form__section m-form__section--first">
			<div class="m-form__heading px-2 pt-4">
				<h3 class="m-form__heading-title"><?php echo translate($this->application_settings->entity_name. ' Setup Details');?></h3>
			</div>
			<?php echo form_open_multipart($this->uri->uri_string(),'class="m-form m-form--state m-form--label-align-left-" id="create_group_form" autocomplete="off"');?>
				<div class="form-group m-form__group row pt-0 m--padding-10">
					<div class="col-lg-6 col-sm-6 m-form__group-sub name">
						...
						<?php echo form_input('group_name','','class="form-control m-input m-input--air capitalize" autocomplete="off" placeholder="Name of the '.$this->application_settings->entity_name.'"');?>
						<span class="m-form__help"><?php echo translate('Please enter your '.$this->application_settings->entity_name.' name');?></span>
					</div>
					<div class="col-lg-6 col-sm-6 m-form__group-sub">
						...
						<?php echo form_input('group_size','','autocomplete="off" class="form-control m-input m-input--air numeric" name="group_size" placeholder="eg 10"');?>
						<span class="m-form__help"><?php echo translate('how many members are there in your '.$this->application_settings->entity_name);?>?</span>
					</div>
				</div>
				<div class="form-group m-form__group row pt-0 m--padding-10">
					<div class="col-lg-6 col-sm-6 m-form__group-sub m-input--air">
						<label class="form-control-label"><?php echo translate('Type of '.$this->application_settings->entity_name);?>: <span class="required">*</span></label>
						<?php echo form_dropdown('group_type',array(''=>'--'.translate('Select type').'--')+translate($type_of_groups),'','class="full-width form-control m-select2" autocomplete="off"');?>
						<span class="m-form__help"><?php echo translate('Please select one option');?></span>
					</div>
					<div class="col-lg-6 col-sm-6 m-form__group-sub m-input--air">
						<label class="form-control-label"><?php echo translate('Your '.$this->application_settings->entity_name.' Role');?>: <span class="required">*</span></label>
						<?php echo form_dropdown('group_role_key',array(''=>'--'.translate('Select '.$this->application_settings->entity_name.' role').'--')+translate($system_group_roles)+translate(array(0=>'Member'))+translate(array(-1=>'Organization Staff')),'','class="full-width form-control m-select2" autocomplete="off"');?>
						<span class="m-form__help"><?php echo translate('Please select one option');?></span>
					</div>
				</div>
				<div class="row form-group m-form__group pt-0 m--padding-10">
					<div class="col-lg-6 col-sm-6 m-form__group-sub m-input--air">
						...
						<?php
							echo form_dropdown('country_id',array(''=>'--'.translate('Select country').'--')+translate($countries),$this->current_country?$this->current_country->id:$this->default_country->id,'class="full-width form-control m-select2" autocomplete="off"');?>
					</div>
					<div class="col-lg-6 col-sm-6 m-form__group-sub m-input--air">
						<label class="form-control-label"><?php echo translate('Group Currency');?>:</label>
						<?php echo form_dropdown('currency_id',array(''=>'--'.translate('Select operating currency').'--')+translate($currencies),$this->current_country?$this->current_country->id:$this->default_country->id,'class="full-width form-control m-select2" autocomplete="off"');?>
					</div>
				</div>
				<div class="row form-group m-form__group pt-0 m--padding-10">
					<div class="col-sm-4 m-form__group-sub">
						<label class="form-control-label"><?php echo translate('Are you a registered entity');?>?: <span class="required">*</span></label>
					...
					<div class="col-sm-8 m-form__group-sub" id="group-registration-certificate">
						<label class="form-control-label"><?php echo translate('Enter the '.$this->application_settings->entity_name.' registration certificate number');?>: <span class="required">*</span></label>
						<?php echo form_input('group_registration_certificate_number','','class="form-control m-input m-input--air uppercase" autocomplete="off" placeholder="eg BazT567Lk/'.date('Y').'"');?>
		...
		var t = function () {
			$(document).on('click',".btn#create_group",function (t) {
				...
				a.validate({
					...
					messages: {
						group_size: {
							min: "<?php echo translate('Minimum three group members');?>"
						},
					}
				});
				if(a.valid()){
