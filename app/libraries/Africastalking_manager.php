...
// require_once APPPATH . 'third_party/AfricasTalking/AfricasTalking.php';

class Africastalking_manager extends AfricasTalkingGateway
{
    private $CI;            //incase we may need to use the Codeigniter Instance
    private $config;

    protected $africastalking_status_codes = array(
        '100'=> 'Processed',
        '101'=> 'Sent',
        '102'=> 'Queued',
        '401'=> 'RiskHold',
