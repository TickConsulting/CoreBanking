        ...
        if(tabsHeight > individualTabHeight) {
            ...
            $tabs.each(function() {
                ...
                if(thisTabPos.top > firstTabPos.top) {
                    ...
                    if(!$dropdown.length) {
                        var dropdownMarkup = '<li class="dropdown show responsivetabs-more nav-item dropdown m-tabs__item">'
                        + '<a href="#" class="dropdown-toggle cllpse_mnu_more nav-link m-tabs__link dropdown-toggle" data-toggle="dropdown">More</a>'
